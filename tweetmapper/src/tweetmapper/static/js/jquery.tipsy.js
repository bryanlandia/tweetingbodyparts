    ...
    Tipsy.prototype = {
        show: function() {
            ...
            if (title && this.enabled) {
                ...
                var pos = $.extend({}, {
                    top: parseFloat(this.$element.attr('y')) || 0,  // these are edited from original jquery.tipsy.js
                    left: parseFloat(this.$element.attr('x')) || 0,  // these are edited from original jquery.tipsy.js
                ...
                switch (gravity.charAt(0)) {
                    case 'n':
                        ...
                        break;
                    case 's':
                        tp = {top: pos.top - actualHeight - this.options.offset, left: pos.left + pos.width / 2 - actualWidth / 2 + this.options.offset};
                        break;
                    case 'e':
